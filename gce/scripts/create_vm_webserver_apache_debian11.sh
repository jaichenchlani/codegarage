...
echo "***** Create Webserver Apache on Debian START *****"
...
vm_name=$vm_name_webserver_apache_debian
image=$debian_image
disk_size=10
startup_script=$webserver_apache_debian_startup_script
...
echo "***** Create Webserver Apache on Debian END *****"