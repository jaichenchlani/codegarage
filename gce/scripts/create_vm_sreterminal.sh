...
echo "***** Create Bastion Host sreterminal START *****"
...
let "count++" # Create Bastion Host sreterminal 
vm_name=$vm_name_sreterminal
image=$centos_image
disk_size=20
startup_script=$sreterminal_startup_script
echo "$count) Creating $vm_name with Image $image..."
...
echo "***** Create Bastion Host sreterminal END *****"